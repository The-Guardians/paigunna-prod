var Item = /** @class */ (function () {
  function Item(name, isEnabled, confirm) {
    this.name = name;
    this.confirm = confirm;
    this._isEnabled = false;
    this._isEnabled = isEnabled;
  }
  Item.prototype.isEnabled = function (value) {
    var _this = this;
    if (value === undefined) {
      return this._isEnabled;
    }
    else if ((value != this._isEnabled) && this.confirm) {
      this.confirm(this, value).then(function (confirmed) {
        if (confirmed) {
          _this._isEnabled = value;
        }
      });
    }
  };
...
var MainController = /** @class */ (function () {
  function MainController($q, $timeout, $window) {
    this.$q = $q;
  ...
  MainController.prototype.confirm = function (item, newValue) {
    var _this = this;
    return this.$q(function (resolve, reject) {
      ...
      _this.$timeout(function () {
        ...
        var confirmed = _this.$window.confirm('Are you sure you want to disable');
  ...
  MainController.prototype.refreshList = function () {
    ...
    this.$timeout(function () {
      _this.items = [
        new Item('Stuff', true, _this.confirm.bind(_this)),
        new Item('Things', false, _this.confirm.bind(_this))
      ];
    }, 600);
  };
  MainController.$inject = ['$q', '$timeout', '$window'];
...
(function () {
  ...
  angular.module('ui.toggle', [])
    ...
    .controller('ToggleController', ['$scope', '$attrs', '$interpolate', '$log', 'toggleConfig', '$toggleSuppressError', '$timeout',
      function ($scope, $attrs, $interpolate, $log, toggleConfig, $toggleSuppressError, $timeout) {
        ...
        this.computeStyle = function () {
          ...
          if (self.height) {
            ...
            var useComputedHeight = wrapperHeight < wrapperComputedHeight &&
